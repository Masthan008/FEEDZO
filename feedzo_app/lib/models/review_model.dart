...
/// Aggregate rating summary for targets
class RatingSummary {
  ...
  Map<int, double> get distribution {
    ...
    return {
      5: fiveStarCount / totalReviews,
      4: fourStarCount / totalReviews,
      3: threeStarCount / totalReviews,
      2: twoStarCount / totalReviews,
      1: oneStarCount / totalReviews,
    };
  }
}
